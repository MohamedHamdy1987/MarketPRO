...
window.openTreasuryDetails = async function (treasuryId) {
  ...
  app.innerHTML = `
    ...
    ">
      <div style="
        flex:1;min-width:140px;background:#e3f2fd;border-radius:10px;padding:14px 16px;
        border-right:4px solid #2196F3;
      ">
        <div style="font-size:12px;color:#1565C0;margin-bottom:4px;">إجمالي التحصيلات</div>
        <div style="font-weight:700;font-size:18px;color:#1565C0;">${formatCurrency(totalIncome)}</div>
      </div>
      <div style="
        flex:1;min-width:140px;background:#ffebee;border-radius:10px;padding:14px 16px;
        border-right:4px solid #f44336;
      ">
        <div style="font-size:12px;color:#b71c1c;margin-bottom:4px;">إجمالي المصروفات</div>
        <div style="font-weight:700;font-size:18px;color:#b71c1c;">${formatCurrency(totalExpense)}</div>
      </div>
      <div style="
        flex:1;min-width:140px;background:${netBalance >= 0 ? '#e8f5e9' : '#fff3e0'};
        border-radius:10px;padding:14px 16px;
        border-right:4px solid ${netBalance >= 0 ? '#4caf50' : '#ff9800'};
      ">
        <div style="font-size:12px;color:${netBalance >= 0 ? '#1b5e20' : '#e65100'};margin-bottom:4px;">صافي الرصيد</div>
        <div style="font-weight:700;font-size:18px;color:${netBalance >= 0 ? '#1b5e20' : '#e65100'};">${formatCurrency(netBalance)}</div>
      </div>
    </div>
    ...
    <div style="display:flex;gap:14px;direction:rtl;align-items:flex-start;flex-wrap:wrap;">
      ...
      <div style="flex:1;min-width:260px;">
        <div style="
          ...
          display:flex;align-items:center;justify-content:space-between;
        ">
          <span style="color:#fff;font-weight:700;font-size:15px;">📥 التحصيلات</span>
          <button
        ...
        <div style="
          background:#f8fbff;border:1px solid #BBDEFB;border-top:none;
      ...
      <div style="flex:1;min-width:260px;">
        <div style="
          ...
          display:flex;align-items:center;justify-content:space-between;
        ">
          <span style="color:#fff;font-weight:700;font-size:15px;">📤 المصروفات</span>
          <button
            onclick="khazna_expense_for('${treasuryId}')"
            style="
              background:#fff;color:#b71c1c;border:none;border-radius:6px;
              padding:6px 12px;font-weight:700;cursor:pointer;font-size:13px;
            ">
            ➖ مصروف
          </button>
        ...
        <div style="
          background:#fff8f8;border:1px solid #FFCDD2;border-top:none;
          border-radius:0 0 10px 10px;padding:12px;min-height:100px;
        ">
          ${expenseRows.length
